...
extern void prvEdfCheckDeadlineTrace(void);\
prvEdfCheckDeadlineTrace();

#define traceTASK_SWITCHED_IN()\
extern void prvRecordStartTimeTrace(BaseType_t xTaskNumber, BaseType_t xTCBNumber);\
prvRecordStartTimeTrace(pxCurrentTCB[0]->uxTaskNumber, pxCurrentTCB[0]->uxTCBNumber);\

#define traceTASK_SWITCHED_OUT()\
extern void prvEdfUpdatePrioritiesTrace();\
extern void prvRecordEndTimeTrace(BaseType_t xTaskNumber, BaseType_t xTCBNumber);\
prvEdfUpdatePrioritiesTrace();\
prvRecordEndTimeTrace(pxCurrentTCB[0]->uxTaskNumber, pxCurrentTCB[0]->uxTCBNumber);
